...
namespace Shop.ApplicationServices.Services
{
    public class WeatherForecastServices : IWeatherForecastServices
    {
        ...
        {
            string apikey = "RUJsc8Wxiup6AZHcq0LnfymDwAs3gVzu";
            var url = $"http://dataservice.accuweather.com/forecasts/v1/daily/1day/127964?apikey=RUJsc8Wxiup6AZHcq0LnfymDwAs3gVzu&metric=true";
